...
$question = $conection->query("SELECT * FROM question2");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <? foreach($question as $q)?>
        ...
        <div class="tow">
            <p><a href="/no/no 1.html"><?=$q['answer1']?></a></p>
            <p><a href="/no/no 1.html"><?=$q['answer3']?></a></p>
            <p><a href="/you/question2.php"><?=$q['answer2']?></a></p>
            <p><a href="/no/no 1.html"><?=$q['answer4']?></a></p>
        </div>
        ?>
    </div>
</body>
