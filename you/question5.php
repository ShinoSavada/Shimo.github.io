...
$question = $conection->query("SELECT * FROM question6");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <? foreach($question as $q)?>
        ...
        <div class="tow">
            <p><a href="/no/no 5.html"><?=$q['answer1']?></a></p>
            <p><a href="/no/no 5.html"><?=$q['answer2']?></a></p>
            <p><a href="/you/question6.php"><?=$q['answer3']?></a></p>
            <p><a href="/no/no 5.html"><?=$q['answer4']?></a></p>
        </div>
    </div>
    ?>
</body>
