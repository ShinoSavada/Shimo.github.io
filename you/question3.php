...
$question = $conection->query("SELECT * FROM question4");
?>
<!DOCTYPE html>
<html lang="ru">
<head>
...
<body>
    ...
    <? foreach($question as $q)?>
        ...
        <img src="/img/wera.jpg" class="pl" alt="">
        <div class="tow">
            <p><a href="/no/no 3.html"><?=$q['answer1']?></a></p>
            <p><a href="/no/no 3.html"><?=$q['answer2']?></a> </p>
            <p><a href="/no/no 3.html"><?=$q['answer3']?></a></p>
            <p><a href="/poli/carta.html"> <?=$q['answer4']?></a></p>
        </div>
    </div>
    ?>
</body>
