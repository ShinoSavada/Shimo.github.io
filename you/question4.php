...
$question = $conection->query("SELECT * FROM question5");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <? foreach($question as $q)?>
        ...
        <img src="/img/li.jpg" class="pl" alt="">
        <div class="tow">
            <p><a href="/no/no 4.html"><?=$q['answer1']?></a></p>
            <p><a href="/no/no 4.html"><?=$q['answer4']?></a></p>
            <p> <a href="/poli/carta2.html"><?=$q['answer2']?></a></p>
            <p><a href="/no/no 4.html"><?=$q['answer3']?></a></p>
        </div>
    </div>
    ?>
</body>
